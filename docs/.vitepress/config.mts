      ...
      '/introduction/': [
        {
          ...
          items: [
            ...
            { text: 'Связь инструментов', link: '/introduction/communication-between-tools' },
            { text: 'Категории инструментов', link: '/introduction/categories-of-tools' }
          ]
        },
        {
          ...
          items: [
            ...
            { text: 'fMirror Arbitrage', link: '/infofields/fmirror-arbitrage' },
            { text: 'fNews', link: '/infofields/fnews' },
            { text: 'Как работать с инфополем?', link: '/infofields/how-to-work-with-infofield' }
          ]
        },
        {
          ...
          items: [
            ...
            { text: 'Что Воркает Фармилка [TO DO]', link: '/working-tools/to-do' },
            ...
            { text: 'Пулы и складчины', link: '/working-tools/pools-and-stacks' },
        ...
        },
        {
          ...
          items: [
            { text: 'Фармилка [Анонсы и Новости]', link: '/community-tools/announcements-and-news' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Структура ролей', link: '/roles-airdrops/structure-of-roles' },
            ...
            { text: 'Структура аирдропов и поощрений', link: '/roles-airdrops/structure-of-rewards' },
            { text: 'Награды за полезную активность', link: '/roles-airdrops/valuable-activity-rewards' },
            { text: 'Награды за активность в ключевых инструментах', link: '/roles-airdrops/key-activity-rewards' },
            { text: 'Награды за признательность со стороны комьюнити', link: '/roles-airdrops/community-appreciation-rewards' },
            { text: 'Ежемесячное командное распредление пула', link: '/roles-airdrops/monthly-team-rewards' },
          ]
        },
        {
          text: 'Обзоры Мирроров',
          items: [
            { text: 'fMirror Alpha 1.0', link: '/mirrors-review/fmirror-alpha-1' },
            { text: 'fMirror Alpha 2.0', link: '/mirrors-review/fmirror-alpha-2' },
            { text: 'Зарубежная Альфа', link: '/mirrors-review/foreign-alpha' },
            { text: 'fMirror Trade', link: '/mirrors-review/fmirror-trade' },
            { text: 'fMirror Arbitrage', link: '/mirrors-review/fmirror-arbitrage' }
          ]
        },
      ],
      '/infofields/': [
      ...
      '/content-hub/': [
        {
          ...
          items: [
            ...
            { text: 'Хэштеги и правила постинга', link: '/content-hub/hashtags' },
